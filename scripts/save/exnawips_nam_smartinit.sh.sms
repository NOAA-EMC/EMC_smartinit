###################################################################
echo "----------------------------------------------------"
echo "exnawips - convert NAM SMARTINIT GRIB files into GEMPAK Grids"
echo "----------------------------------------------------"
echo "History: Mar 2000 - First implementation of this new script."
echo "History: Jul 2011 - Modified original exnawips scripts for "
echo "                    nam smartinit jobs"
#####################################################################
cd $DATA
...
while [ $fhcnt -le $fend ] ; do
  ...
  case $RUN in
   ...
   smartconus2p5) GRIBIN=$COMIN/nam.${cycle}.smartconus2p5${fhr}.tm00
	          GEMGRD=smartconus2p5_${PDY}${cyc}f${fhr} ;;
   smartak) GRIBIN=$COMIN/nam.${cycle}.smartak${fhr}.tm00
	       GEMGRD=smartak_${PDY}${cyc}f${fhr} ;;
   smartak3) GRIBIN=$COMIN/nam.${cycle}.smartak3${fhr}.tm00
	       GEMGRD=smartak3_${PDY}${cyc}f${fhr} ;;
