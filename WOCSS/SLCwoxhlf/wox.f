...
C
	...
	open (56,file='Macintosh_HD:JAZ04:slcout1km:inprofs',
...
c!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
c
	chpath='Macintosh_HD:JAZ04:slchalfkm:'
	chmesh='h'
	write (*,*) chpath,' ',chmesh,' km grid'
c
...
c
	open(33,file='Macintosh_HD:'//chpout//'test'//
     $	     chmesh//'km',form='formatted', status='unknown')
c
	write (16,*) 'starting'
	write (*,*) 'starting'
c
...
c
	close (11)
	write (16,*) 'closed',chpath,'halfkm.dat'
	write (16,*) 'opening ',chpath,'slcfiles'
C
       	open(11,file=chpath//'slcfiles',
...
44	read (11,6003,end=8586) chfnam
	...
	write (16,*) chmmddtttt
c
	write (16,*) 'opening '//chpath//chfnam
	write (*,*) 'opening '//chpath//chfnam
	open (12,file=chpath//chfnam,
     $         status='old',form='formatted',readonly)
c
	 write (16,*) 'opened '//chpath//chfnam
c
...
c
	      ...
	      open(35,file='Macintosh_HD:'//chpvex//'u'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	      write(35) iugraf  
	      close (35)
c
	      open(35,file='Macintosh_HD:'//chpvex//'v'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	      write(35) ivgraf
	      close (35)	
...
c
	      if (dowcmp) then
	         open(35,file='Macintosh_HD:'//chpvex//'w'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	         write(35) iwgraf 
		 close (35) 
...
c
	      if (dothet) then
	         open(35,file='Macintosh_HD:'//chpvex//'PT'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	         write(35) iptgrf
		 close (35) 
...
c
	      if (dopres) then
	         open(35,file='Macintosh_HD:'//chpvex//'pr'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	         write(35) iprgrf
		 close (35)
...
c
	      if (doBRi) then
	         open(35,file='Macintosh_HD:'//chpvex//'Ri'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	         write(35) irngrf
		 close (35)
...
c
	      if (doBVpd) then
	         open(35,file='Macintosh_HD:'//chpvex//'BV'//
     $	                   chmesh//'km.'//chddhr,
     $	                   form='unformatted', status='unknown')
	         write(35) ibvgrf
		 close (35)
...
c
     ...
     $	                 chddhr
	            open (50,file='Macintosh_HD:'//chpvex//'ufobs'//
     $	                 chmesh//'km-allz.'//chddhr,form='formatted',
     $                                    status='unknown')
	            open (51,file='Macintosh_HD:'//chpvex//'vfobs'//
     $	                chmesh//'km-allz.'//chddhr,form='formatted',
     $                                    status='unknown')
                    open(40,file='Macintosh_HD:'//chpvex//'PTobs'//
     $	                 chmesh//'km-allz.'//chddhr,form='formatted',
     $                                     status='unknown')  
                    open(41,file='Macintosh_HD:'//chpvex//'probs'//
     $	                chmesh//'km-allz.'//chddhr,form='formatted',
     $                                     status='unknown') 
...
c
	         if (dotopo) then
	            open(31,file='Macintosh_HD:'
     $                        //chpvex//'locltopo',status='unknown') 
...
c
c
	         open (46,file='Macintosh_HD:'//chpvex//'uf'//chmesh//
     $	                         'km-allz.'//chddhr,form='formatted',
     $                                    status='unknown')
	         open (47,file='Macintosh_HD:'//chpvex//'vf'//chmesh//
     $	                         'km-allz.'//chddhr,form='formatted',
     $                                    status='unknown')
	         if (dowcmp) open(35,file='Macintosh_HD:'//chpvex//
     $                 'wf'//chmesh//'km-allz.'//chddhr,
     $	                form='formatted', status='unknown')
                                       
	         if (dothet) then
                    open (36,file='Macintosh_HD:'//chpvex//'PT'//
     $	                 chmesh//'km-allz.'//chddhr,form='formatted',
     $                                    status='unknown')
	         end if
c
	         if (dopres) then
                    open(37,file='Macintosh_HD:'//chpvex//'pr'//
     $	                 chmesh//'km-allz.'//chddhr,form='formatted',
     $                                     status='unknown')
	         end if
c
	         if (doBRi)  open(38,file='Macintosh_HD:'//chpvex//
     $                           'Rif'//chmesh//'km-allz.'//chddhr,
     $	                 form='formatted',status='unknown')
	         if (doBVpd) open(39,file='Macintosh_HD:'//chpvex//
     $                   'BV'//chmesh//'km-allz.'//chddhr,
     $	                 form='formatted',status='unknown')
	         do 195 iz=1,NFLAT
c
...
c
	   do 175 ip=1,npfyls	
	      open(46,file='Macintosh_HD:'//chpvex//'wndprof'//
     $              chpro(ip),form='formatted', status='unknown')
c
...
c
	   do 275 ip=1,npfyls
	      open(47,file='Macintosh_HD:'//chpvex//'wndtser'//
     $              chpro(ip),form='formatted', status='unknown')
...
c
c
	write(*,*) 'Macintosh_HD:'//chpout//'outfyl'//
     $	     chmesh//'km'
	open(16,file='Macintosh_HD:'//chpout//'outfyl'//
     $	     chmesh//'km',form='formatted',status='unknown')
     	write (*,*) chpath//'runstf'//chmesh//'.dat'
c
	read (22,*) DBUG,dbug2
...
c  5 km salt lake area terrain data read
 		if (chmesh.eq.'5') then
 	            read (11,6002) (sfcht(ix,jy),ix=1,ncol)
c
		else if (chmesh.eq.'2') then
c
c*****************************************************************
...
c
		else if (chmesh.eq.'h') then

	   	   read (11,6003) (sfcht(ix,jy),ix=1,ncol)
c
c
		else
c
...
c
		  write (*,*) chmesh,
     $             ' km is not an available grid spacing'
		  write (*,*) 'carriage return to stop.'
		  pause
		  stop
c
		end if
...
c	 	
	if (ncalls.eq.1) then
	   open(52,file='Macintosh_HD:'//chpvex//'heights'//
     $	                   chmesh//'km',
     $                     status='unknown',form='formatted')
	   open(53,file='Macintosh_HD:'//chpvex//'speeds'//
     $	                   chmesh//'km',
     $                     status='unknown',form='formatted')
	   open(54,file='Macintosh_HD:'//chpvex//'dirctns'//
     $	                   chmesh//'km',
     $                     status='unknown',form='formatted')
	 end if
c
...
c
	open(52,file='Macintosh_HD:ptest',form='formatted',status=
     $       'unknown')
55	continue
	close (52)
	k1=1
...
c
     ...
     $                                     (zagl-RHS(IX,IY,NLVL))
		    ...
		    if (IPRGRF(IX,IY,IZ).eq.-99990) then
		       write(*,*) '1. bad altim or ht ',atop,zmsl
		       stop
		    end if
c
