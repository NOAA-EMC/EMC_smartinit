...
!  TYPE VOUT, INTENT(OUT) :: down
   REAL,    ALLOCATABLE :: TOPO(:,:),ROUGH(:,:),VEG(:,:)  !move to aset2d
...
!==========================================================
   ...
   ALLOCATE (D2(IM,JM),U10(IM,JM),V10(IM,JM),VEG(IM,JM),BLI(IM,JM),STAT=kret)
...
!  CALL THE DOWNSCALING CODE 
       ...
       CALL NDFDgrid(VEG,DOWNT,DOWNDEW,DOWNU,DOWNV,DOWNQ,TOPO,gdin)
...
!JTM     Corrected  ERROR...Added *100 11/25/12
...
!======================================================================
!--->   COMPUTE SNOW FALL  FOR 3 and 6 HR PERIODS
!======================================================================
...
!         print *,i,j,'sky',SKY(i,j),'tsky',TSKY
...
!      print *,QPFtmp,factor,factor2,rhmx,DPOP 
