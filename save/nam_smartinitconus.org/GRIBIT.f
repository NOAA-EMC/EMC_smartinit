      SUBROUTINE GRIBIT(ID,RITEHD,GRID,DATE,IFHR,LUNOUT,DECI)
...
C        ID(11) = VALUE 2 OF LEVEL
 666   WRITE(6,1050) ID(8),FIELD(IFLD),ID(9),ID(10),ID(11),ID(18),ID(19)
 1050 FORMAT('GRIBIT:  ',I3,1X,A20,1X,I3,1X,I5,1X,3I5)
C     
C     END OF ROUTINE.
C     
c      END IF
