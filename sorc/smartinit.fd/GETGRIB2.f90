...
!   14-10-27  A.GIBBS    - Changes to process GRIB2 (following Matt Pyle's
...
!     JPDS(6) = 245
!     CALL
!     SETVAR(LUGB,LUGI,NUMVAL,J,JPDS,JGDS,KF,K,KPDS,KGDS,MASK,GRID,WETFRZ,IRET,ISTAT)
