...
!                 12hrp=fhr6 + fhr
!  
! 05-16-15 AMG Added GRIB2 code and option to choose GRIB1 or GRIB2 input/output
!
! ATTRIBUTES:
!   LANGUAGE: FORTRAN-90
!   MACHINE:  WCOSS     
...
!--------------------------------------------------------------------------
      ...
      IGDNUM=1 ! Temporarily set so GRIB2 code will work
