...
program tst_io
  ...
  real, parameter :: psr = 1.7/real(prsz1)
  integer :: clockRate
...
2 format("Time for", i5, a, i3, a23, i6," msec. ", a, i6)
  ...
  call system_clock(start)
  write(13, iostat = iosb) s
  call check (iosb, 6)
  write(14, iostat = iosb) t
  call check (iosb, 7)
  write(15, iostat = iosb) u
  call check (iosb, 8)
  write(16, iostat = iosb) v
  call check (iosb, 9)
  write(17, iostat = iosb) w
  call check (iosb, 10)
  write(18, iostat = iosb) x
  call check (iosb, 11)
  write(19, iostat = iosb) y
  call check (iosb, 12)
  write(20, iostat = iosb) z
  call check (iosb, 13)
  call system_clock(now)
  wrint3 = now - start
