...
! $Id$
  ...
  integer, external :: nf_create_par, nf_open_par, nf_var_par_access,     &
       nf_inq_ncid, nf_inq_grps, nf_inq_grpname, nf_inq_grpname_full, nf_inq_grpname_len, &
       nf_inq_grp_parent, nf_inq_grp_ncid, nf_inq_varids, &
       ...
       nf_inq_compound_fielddim_sizes, nf_inq_compound_fieldoffset, nf_def_vlen, nf_inq_vlen, nf_free_vlen, &
       nf_inq_user_type, nf_def_enum, nf_insert_enum, nf_inq_enum, nf_inq_enum_member, nf_inq_enum_ident, &
       ...
       nf_put_vars, nf_get_vars, nf_inq_grp_full_ncid, nf_put_vlen_element
