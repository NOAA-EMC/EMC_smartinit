...
public :: nf90_create_par, nf90_open_par, nf90_var_par_access, &
     nf90_inq_ncid, nf90_inq_grps, nf90_inq_grp_ncid, nf90_inq_grpname, &
     nf90_inq_grpname_len, nf90_inq_varids, nf90_inq_grp_parent, &
     ...
     nf90_inq_var_chunking, nf90_def_var_fill, nf90_inq_var_fill, &
