...
C GRIB2 must set resolution code to 136 - so to convert grd91 from
C GRIB2 to GRIB1, we must change resolution code from 8 to 136.
C     DATA  GRD91 / 0, 255, 5,1649,1105, 40530,  -178571,  8,  -150000,
C    &  2976, 2976,   0, 64, 0, 0, 0, 0, 0/
      DATA  GRD91 / 0, 255, 5,1649,1105, 40530,  -178571, 136,  -150000,
...
C PUTGB2 must set resolution code to 136 - so to convert grd195 from
C GRIB2 to GRIB1, we must change resolution code from 128 to 136.
C     DATA  GRD184/ 0, 255, 3,2145,1377,  20192, -121554,   8,  -95000,
C    &    2540,   2540, 0, 64, 0, 25000, 25000, 0, 0/
      DATA  GRD184/ 0, 255, 3,2145,1377,  20192, -121554, 136,  -95000,
     &    2540,   2540, 0, 64, 0, 25000, 25000, 0, 0/
      DATA  GRD187/ 0, 255, 3,2145,1597,  20192, -121554,   8,  -95000,
     &    2540,   2540, 0, 64, 0, 25000, 25000, 0, 0/
C     DATA  GRD188/ 0, 255, 3, 709, 795,  37979, -125958,   8,  -95000,
C    &    2540,   2540, 0, 64, 0, 25000, 25000, 0, 0/
C Temporary expanded CONUS nest grid - used for Dec 2015 upgrade
      DATA  GRD188/ 0, 255, 3,2345,1597,  19229, -126277,   8,  -95000,
     &    2540,   2540, 0, 64, 0, 25000, 25000, 0, 0/
C Temporary expanded CONUS nest grid - use for next upgrade???  For
C GRIB2
C     DATA  GRD188/ 0, 255, 3,2345,1597,  19228, -126277,   8,  -95000,
C    &    2539,   2539, 0, 64, 0, 25000, 25000, 0, 0/
...
C PUTGB2 must set resolution code to 136 - so to convert grd195 from
C GRIB2 to GRIB1, we must change resolution code from 128 to 136.
C     DATA  GRD195/ 0, 255, 1, 177,129,  16829,  -68196, 128,   19747,
C    &  -63972,  2500,  2500, 20000, 64, 0, 0, 0, 0/
      DATA  GRD195/ 0, 255, 1, 177,129,  16829,  -68196, 136,   19747,
     &  -63972,  2500,  2500, 20000, 64, 0, 0, 0, 0/
      DATA  GRD196/ 0, 255, 1, 321,225,  18073, -161525, 136,   23088,
     & -153869, 2500, 2500, 20000, 64, 0, 0, 0, 0/
C PUTGB2 must set resolution code to 136 - so to convert grd197 from
C GRIB2 to GRIB1, we must change resolution code from 8 to 136.
C     DATA  GRD197/ 0, 255, 3,1073,689,  20192, -121550,   8,  -95000,
C    &    5079,   5079, 0, 64, 0, 25000, 25000, 0, 0/
      DATA  GRD197/ 0, 255, 3,1073,689,  20192, -121550, 136,  -95000,
     &    5079,   5079, 0, 64, 0, 25000, 25000, 0, 0/
C PUTGB2 must set resolution code to 136 - so to convert grd198 from
C GRIB2 to GRIB1, we must change resolution code from 8 to 136.
C     DATA  GRD198/ 0, 255, 5, 825, 553, 40530,  -178571,  8,  -150000,
C    &  5953, 5953,   0, 64, 0, 0, 0, 0, 0/
      DATA  GRD198/ 0, 255, 5, 825, 553, 40530,  -178571, 136,  -150000,
...
C     DATA  GRD254/ 0, 255, 1, 369,300, -35000, -250000, 128,   60789,
C    & -109129, 40000,40000, 20000, 64, 0, 0, 0, 0/
C Temporary grid for PR 1.25 km
      DATA  GRD254/ 0, 255, 1, 339,225, 16977, -68028, 128,   19522,
     & -63985, 1250,1250, 20000, 64, 0, 0, 0, 0/
C
      IERR = 0
C
        DO 1 I = 1,18
