C-----------------------------------------------------------------------
C      SUBROUTINE PUT_GB(KF,NBITS,KPDS,KGDS,LB,F,LGRIB,GRIB,IRET)
      SUBROUTINE PUT_GB(KGRIDM,KF,NBITS,KPDS,KGDS,LB,F,LGRIB,GRIB,IRET)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C
C SUBPROGRAM: PUT_GB         PACKS AND WRITES A GRIB MESSAGE
C   PRGMMR: IREDELL          ORG: W/NMC23     DATE: 94-04-01
C
C ABSTRACT: PACK A GRIB MESSAGE.
...
C
C USAGE:    CALL PUT_GB(KF,KPDS,KGDS,LB,F,IRET)
C   INPUT ARGUMENTS:
