...
!jtm      PARAMETER(IMAXOT=2200,JJMAXOT=1500,JMAXOT=IMAXOT*JJMAXOT) 
      PARAMETER(IMAXOT=2200,JJMAXOT=1600,JMAXOT=IMAXOT*JJMAXOT)
!rv   PARAMETER(MAXTILE=54,MAXF=2000,MAXG=10,IBUFSIZE=2140000000)
      PARAMETER(MAXTILE=54,MAXF=2000,MAXG=10,IBUFSIZE=1200000000)
!rv --- 2GB was too large
